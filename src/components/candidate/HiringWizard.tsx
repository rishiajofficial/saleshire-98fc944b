...
import { PreHiringTrainingExplanation } from "./PreHiringTrainingExplanation";
...
export const HiringWizard = ({ 
  ...
  // Show training explanation when candidate reaches step 3 (training step)
  const showTrainingExplanation = currentStep >= 3 && currentStep <= 3;

  return (
    <div className="space-y-6">
      {showTrainingExplanation && (
        <PreHiringTrainingExplanation />
      )}
